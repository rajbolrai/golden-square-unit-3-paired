...
def test_given_string_without_TODO_will_output_false():
    result = include_to_do("hello")
    assert result == False
    
def test_given_with_TODO_at_start_output_true():
    result = include_to_do("#TODO hello")
    assert result == True